...
<template>
  <section class="mx-auto max-w-md">
    <div class="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm sm:p-7">
      <h1 class="mb-2 text-2xl font-semibold text-zinc-900">Create account</h1>
      ...
      <form class="space-y-4" @submit.prevent="onSubmit">
        ...
        <AppButton class="w-full" type="submit" :loading="pending">Create account</AppButton>
      </form>
    </div>

    <p class="mt-5 text-sm text-zinc-600">
      Already have an account?
      <NuxtLink class="font-medium text-zinc-900 underline" to="/auth/login"
        >Login</NuxtLink
      >
    </p>
  </section>
